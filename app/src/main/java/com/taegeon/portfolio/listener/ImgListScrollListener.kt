...
const val REMAIN_ITEM_CNT_TO_LOAD_MORE: Int = 15
...
class ImgListScrollListener(
    ...
    override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
        ...
        if (itemCount - layoutManager.findLastCompletelyVisibleItemPosition() < REMAIN_ITEM_CNT_TO_LOAD_MORE && isSearchable) {
            loadMore()
        }
    }
